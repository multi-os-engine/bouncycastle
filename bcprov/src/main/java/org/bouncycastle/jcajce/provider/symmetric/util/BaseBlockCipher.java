    ...
    implements PBE
{
        ...
        throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        if (scheme == PKCS12 || key instanceof PKCS12Key)
        {
            ...
            // Was: if (k instanceof PBEKey && pbeSpec == null)
            if (k instanceof PBEKey && !(k instanceof BCPBEKey) && pbeSpec == null)
            // END android-changed
            {
                // BEGIN android-added
                if (((PBEKey)k).getSalt() == null) {
                    throw new InvalidAlgorithmParameterException("Salt for PBEKey is null");
                }
                // END android-added
